...
public class Permissions {
	...
	public boolean hasCommandUsePermission(Player player) {
		return hasPermission(player,Main.Config.commandUsePermission(),Main.Config.commandUseOp());
	}
	
	public boolean hasCommandPermission(Player player) {
		return hasPermission(player,Main.Config.commandPermission(),Main.Config.commandOp());
	}
